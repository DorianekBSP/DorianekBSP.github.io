...
function loadButtonsSize() {
	...
	document.getElementById("left_pc").style.height = document.getElementById("photo").offsetHeight + "px";
	document.getElementById("right_pc").style.height = document.getElementById("photo").offsetHeight + "px";
